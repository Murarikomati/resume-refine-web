          ...
          <div className="rounded-xl overflow-hidden shadow-xl bg-card p-6 border border-border">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <InfoItem label="Email" value="murarikomati199ds@gmail.com" />
              ...
              <div className="pt-4 border-t border-border">
                ...
                <div className="flex flex-wrap gap-4">
                  <SocialLink href="https://www.linkedin.com/in/komati-murari/" label="LinkedIn" icon={<Linkedin size={16} />} />
                  <SocialLink href="https://github.com/Murarikomati" label="GitHub" icon={<Github size={16} />} />
                </div>
              </div>
            </div>
          </div>
...
const SocialLink = ({
  ...
  <a
    ...
    className="flex items-center gap-2 px-4 py-2 bg-muted rounded-md text-sm font-medium hover:bg-primary hover:text-primary-foreground transition-colors"
  >
    {icon}
    {label}
  </a>
